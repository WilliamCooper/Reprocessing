...
VarList <- c("ADIFR", "VSPD", "VSPD_G", "PITCH", "QCF", "PSF", "AKRD", "WIC", "TASF", "GGALT")
...
Review of HIPPO-2 measurements from the first two research flights
...
and even within flights. For example, for HIPPO-2 flight 1, Fig.\textasciitilde{}\textbackslash{}ref\{fig:vw-rf1\}
...
show similar problems but with some inconsistency, esp.\textasciitilde{}for
...
This memo will use measurements from rf01--rf02. Some data restrictions
