...
# pdf(file='SpeedRunDelayed.pdf')
Data$X <- Data$TASX^2 / (2 * CP[1])
plotWAC (Data$X, Data$RTHR1, type='l', col='blue', ylim=c(-14,3),
  xlab=expression(0.5~V^2 / C[p]), 
...
lines (Data$X, Data$RTHR1, col='forestgreen')
legend('bottomright', legend=c('unshifted', 'advanced 2.32 s'), text.col=c('blue', 'forestgreen'))
# dev.off()
