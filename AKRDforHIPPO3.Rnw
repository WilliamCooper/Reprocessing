...
FCap1 <- c("Vertical wind, HIPPO-3 flight 3. The blue trace is WIC; the red trace (WICS) is the same measurement after application of 60-s smoothing.", "Residual error as defined in (1) as a function of Mach number. The dashed orange line is the mean value, 4.378.")
...
Review of HIPPO-3 measurements shows that there is often a significant
offset in vertical wind and that there is much variability from flight
to flight and even within flights. For example, for HIPPO-3 flight
...
of the difference for HIPPO-3 flight 1 of -0.02$\pm$0.15\ m/s. The
