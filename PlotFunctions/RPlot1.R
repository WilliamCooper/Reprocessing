...
RPlot1 <- function (data, Flight=NA, Seq=NA) { 
  ...
  par(new=TRUE);plot(data$Time,data[, VRPlot[[1]][5]], axes=F,bty='n', xlab='',ylab='',type='n');axis(4,tck=0.02) ## this adds a metric axis on the right side at even meter intervals
